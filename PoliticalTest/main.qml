...
Window  {
    ...
    property variant questionsString:[                                                           //вопросы теста
        "Монархия и аристократические титулы должны быть отменены",
        "Существует слишком много нерациональных правительственных программ",
        "Смертная казнь должна применяться в некоторых случаях",
        "Государственные расходы с целью создания рабочих мест, как правило, хорошая идея",
        "В целом, профсоюзы приносят больше вреда, чем пользы",
        "Деньги налогоплательщиков не должны быть потрачены на искусство или спорт",
        "В целом, минимальная заработная плата приносит больше вреда, чем пользы",
        "Страна не должна вступать в войну без поддержки со стороны международного сообщества",
        "Сильная армия является лучшим инструментом внешней политики, чем сильная дипломатия",
        "Некоторые страны и культуры являются естественными врагами",
        "Правительство должно перераспределить богатство между богатыми и бедными",
        "Проституция должна быть легализирована",
        "В целом, утечки информации, такие как совершенные при помощи Эдварда Сноудена и WikiLeaks, принесли больше вреда, чем пользы",
        "Если люди хотят ездить с не пристёгнутым ремнем безопасности, это их выбор",
        "Нам нужно увеличить налоги на промышленность в связи с необходимостью решения проблем, связанных с изменением климата",
        "Марихуана должна быть легализирована",
        "Правительство должно предоставить бесплатные медицинские услуги своим гражданам",
        "Я не против, если иммигрант желает вывесить флаг своей страны в моей стране",
        "Свободная торговля для стран третьего мира лучше, чем экономическая помощь",
        "Существует конфликт между интересами бизнеса и интересами общества",
        "Импортные тарифы на иностранные товары являются хорошим способом защиты рабочих мест в моей стране",
        "Западная цивилизация получила более существенные выгоды от Христианства, чем от идей Древней Греции",
        "Программы надзора и борьбы с терроризмом зашли слишком далеко",
        "Иммиграция в мою страну должна быть сведена к минимуму и строго контролироваться",
        "Реабилитация преступников важнее, чем их наказание",
        "Гомосексуальные пары должны иметь те же права, что и гетеросексуальные пары, в том числе и права на усыновление",
        "Когда правительство вовлекается в бизнес, это почти никогда ничем хорошим не заканчивается",
        "Спекуляции на фондовой бирже являются менее желательными, чем другие виды экономической деятельности",
        "Равенство важнее экономического роста",
        "Правительство должно ограничить размер зарплат банкиров и руководителей",
        "Привилегии государственной религии над другими религиями вполне законны",
        "Рынок, как правило, лучше распределяет ресурсы, чем правительство",
        "Некоторые народы и религии, как правило, создают больше проблем, чем другие",
        "Моя страна должна оказывать больше помощи странам третьего мира",
        "Люди, которые отказались от работы, не должны иметь право на получение пособия по безработице от правительства",
        "С медицинской точки зрения, эвтаназия должна быть законной"
    ];
